...
const BookingsTotallyTable = ({ bookings, onDelete }: BookingTableProps) => {
        ...
        <table className="w-full text-left rounded-xl overflow-hidden">
            <thead className="bg-gray-100">
                <tr>
                    ...
                    <th className="p-4 px-10">Data</th>
                </tr>
            </thead>
            <tbody>
                {bookings.map((booking) => (
                    <tr
                        key={booking.id}
                        className={'bg-gray-200 border-t-[0.1px] border-gray-300 cursor-pointer hover:bg-primary hover:scale-105 transition-transform duration-300'}
                        ...
                        <Card className="rounded-xl border-none shadow-none">
                            <CardContent className="flex justify-between p-0">
                                <div className="p-5 space-y-5">
                                    ...
                                    <BookingSummary service={selectedBooking.service} selectedDate={selectedBooking.date} />
...
export default BookingsTotallyTable;